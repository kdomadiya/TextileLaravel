                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card">
                                ...
                                <div class="card-header flex-column flex-md-row">
                                    ...
                                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                                        <div class="dt-buttons"> 
                                            <router-link to='/user-role/create'  class="dt-button create-new btn btn-primary waves-effect waves-light">
                                                <span><i
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                aria-label="Salary: activate to sort column ascending">Permission</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                rowspan="1" colspan="1" style="width: 174px;"
                        ...
                        <tr v-for="data in datas" ::key="data.id">
                            ...
                            <td>
                                <router-link :to='{name:"userrole.edit",params:{id:data.id}}' class="btn btn-success"><i class="fa-regular fa-pen-to-square"></i></router-link>
                                <router-link :to='{name:"userrole.show",params:{id:data.id}}' class="btn btn-primary"><i class="fa-regular fa-eye"></i></router-link>
