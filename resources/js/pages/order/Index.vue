                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card">
                                ...
                                <div class="card-header flex-column flex-md-row">
                                    ...
                                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                                        <div class="dt-buttons"> 
                                            <router-link to='/order/create'  class="dt-button create-new btn btn-primary waves-effect waves-light">
                                                <span>
                        ...
                        <tr v-for="data in datas" ::key="data.id">
                            ...
                            <td>
                                <router-link :to='{name:"order.edit",params:{id:data.id}}' class="btn btn-success"><i class="fa-regular fa-pen-to-square"></i></router-link>
                                <router-link :to='{name:"order.show",params:{id:data.id}}' class="btn btn-primary"><i class="fa-regular fa-eye"></i></router-link>
