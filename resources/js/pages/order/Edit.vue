     ...
     addItem(){
      ...
      showorder(){
        axios.get(`/api/order/${this.$route.params.id}`).then(response=>{
          const {id,account_id,date,tax,subtotal,total} = response.data.data
      ...
      create: function(){
        ...
        if(item.id != null){
          console.log(item.id)
          axios.put(`/api/order/item/${item.id}`,this.order).then(response=>{
               console.log()
              }).catch(error=>{
                console.log(error)
            })
        ...
        // axios.post('/api/order/',this.order).then(response=>{
        //     }).catch(error=>{
        //       console.log(error)
        //   })
      },
      updateOrder: function(){
        this.order.tax = this.tax;
          ...
          axios.put(`/api/order/${this.$route.params.id}`,this.order).then(response=>{
               console.log()
              }).catch(error=>{
                console.log(error)
            })
