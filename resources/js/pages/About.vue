    ...
    <div class="card invoice-preview-card">
      <div class="card-body">
        <div class="row m-sm-4 m-0">
          ...
          <div class="col-md-5">
            <dl class="row mb-2">
              ...
              <dd class="col-sm-6 d-flex justify-content-md-end pe-0 ps-0 ps-sm-2">
                <input type="text" class="form-control w-px-150 date-picker flatpickr-input" placeholder="YYYY-MM-DD" readonly="readonly">
              </dd>
              <dt class="col-sm-6 mb-2 mb-sm-0 text-md-end ps-0">
        ...
        <form class="source-item pt-4 px-0 px-sm-4">
                ...
                <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end w-px-300 p-3" aria-labelledby="dropdownMenuButton">
                      ...
                      <button type="button" class="btn btn-label-primary btn-apply-changes waves-effect">Apply</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row pb-4">
            <div class="col-12">
              <button type="button" class="btn btn-primary waves-effect waves-light" data-repeater-create="">Add Item</button>
            </div>
          </div>
        </form>
