              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ accounts }}</h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ products }}</h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ current_stock }}</h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ orders }}</h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ users }}</h5>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="card">
                  <div class="card-body pb-0">
                    ...
                    <h5 class="card-title mb-0 mt-2">{{ stores }}</h5>
