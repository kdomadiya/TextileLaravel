...
const routes = [
    ...
    {path: '/order', component:Order, props: true, name: 'order.index',meta:{requiresAuth: true}},
    {path: '/order/create', component:OrderCreate, name: 'order.create',  props: (route) => ({propFromIndex: route.params.propFromIndex}), meta:{requiresAuth: true}},
